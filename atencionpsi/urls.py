...
urlpatterns = [
    ...
    path('psicologo/<slug:slug>/reservar/', views.reservar_turno, name='reservar_turno'),
    path('psicologo/<slug:slug>/reservar/confirmar/', views.reservar_confirmar, name='reservar_confirmar'),
